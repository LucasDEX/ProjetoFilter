...
public class RegistrarDAO {
	public int criar(CadastrarLogin registrar) {
	...
	public void atualizar(CadastrarLogin registrar) {
	...
	public CadastrarLogin login(String login, String senha) {
		CadastrarLogin registrar = new CadastrarLogin();
	...
	public List<CadastrarLogin> carregarTodasAreas() {
		CadastrarLogin registrar;
		
		List<CadastrarLogin> lista = new ArrayList<CadastrarLogin>();
